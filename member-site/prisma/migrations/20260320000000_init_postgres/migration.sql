...
CREATE TABLE "ChallengeDeclaration" (
    ...
    CONSTRAINT "ChallengeDeclaration_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ChallengeDeclaration" ADD CONSTRAINT "ChallengeDeclaration_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
